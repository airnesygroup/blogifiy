...
<div className="flex flex-wrap items-center gap-1 sm:gap-2 text-gray-500 text-[11px] sm:text-[11px] md:text-[12px] lg:text-[14px] md:top-[-10px] lg:relative lg:top-[-25px]">
  <span> By</span>
  <Link
